...
function pasarUsuarioAPremium(usuarios) {
  ...
  // Tu código:
  /*usuario ={
  usuarios:[usuario{esPremium:1}, usuario{esPremium:0}, usuario{esPremium:1}],
  ...
  }*/
  var l =usuarios.length
  for (i =0; i <l; i++){
    usuarios[i].esPremium =true //es un solo igual (=) porque estás estableciendo, no comparando.
  }
  return usuarios
}
...
function sumarLikesDeUsuario(usuario) {
  ...
  // que es un array de objetos "post"
  // Cada objeto "post" tiene una propiedad llamada "likes" que es un entero (int/integer)
  // Suma todos los likes de todos los objetos "post"
  // Devuelve la suma
  // Tu código: 
  /*
  usuario={   posts: [post{likes:z},  post{likes:y}]   }*/
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  producto.calcularPrecioDescuento =function(){
      ...
      var resta =this.precio -descuento
      return resta
    }
    return producto
} 
